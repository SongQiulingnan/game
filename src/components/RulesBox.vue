  ...
  <Transition name="rules">
    <div class="rules-box" v-if="show">
      ...
      <div class="rules-content">
        ...
        <div class="rule-section">
          <h4>三、夹吃</h4>
          <p>在同一直线上，两枚己方棋子紧夹一枚敌方棋子（己—敌—己）。限制：该吃子结构两端紧邻的延长点上不能有敌方棋子，仅限此三子都在的那一条线上。执行：吃掉被夹的敌棋，在其原位补上一枚己方备用棋子。</p>
        </div>
        <div class="rule-section">
          <h4>四、挑吃</h4>
          <p>一枚己方棋子移动到两枚敌方棋子中间（敌—己—敌）。限制：该吃子结构两端紧邻的延长点上不能有敌方棋子，仅限此三子都在的那一条线上。执行：同时吃掉两枚敌棋，在两枚被吃棋子原位各补上一枚己方备用棋子。</p>
        </div>
        <div class="rule-section">
          <h4>五、连环吃子</h4>
